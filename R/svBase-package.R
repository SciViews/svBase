...
#' @importFrom collapse add_vars allNA anyv ckmatch fcount fnobs fmatch fselect fsummarise fmutate frename fsubset fgroup_vars fungroup get_collapse get_vars group_by_vars greorder GRP GRPid GRPN gsplit join na_rm replace_NA roworder roworderv seq_row setv ss fgroup_by whichv
