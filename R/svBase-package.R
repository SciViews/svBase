...
#' @importFrom collapse add_vars allNA anyv ckmatch fcount fcountv fnobs fmatch fselect fsum fsummarise fmutate frename fsubset fgroup_vars fungroup fslicev get_collapse get_vars group_by_vars greorder GRP GRPid GRPN gsplit join na_rm replace_NA roworder roworderv seq_row setv ss fgroup_by whichv
